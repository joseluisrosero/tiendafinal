...
urlpatterns = [
    ...
    path('agregar_producto/',login_required(vista_agregar_producto),name='vista_agregar_producto'),
    path('ver_producto/<int:id_prod>/', vista_ver_producto,name='vista_ver_producto'),
    path('editar_producto/<int:id_prod>/', login_required(vista_editar_producto), name='vista_editar_producto'),
    path('eliminar_producto/<int:id_prod>/',login_required( vista_eliminar_producto),name='vista_eliminar_producto'),
